...
import { salvarRascunho } from "../../banco/dados";
import { irParaAba } from "../../estado/navegacao";
import { FORMULARIOS } from "../../dados/estaticos";
import { campos, statusEfetivo, temValor, textoDe, visivel, type CampoAchatado } from "./motor";
import { copiarComAviso } from "../../blocos/Toast";
import { clonar } from "../../util";
import { ROTULO_STATUS_CAMPO, type Rascunho } from "../../tipos";

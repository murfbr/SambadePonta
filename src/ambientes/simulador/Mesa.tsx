...
import {
  excluirRascunho, importarPacote, nomeCandidatura, porId, salvarRascunho, usarCentral,
} from "../../banco/dados";
import { abrirRascunho } from "../../estado/navegacao";
import { FORMULARIOS, REGISTRO, nomePlataforma } from "../../dados/estaticos";
import { novoRascunho, normalizarRascunho, resumoRascunho } from "./motor";
import { toast } from "../../blocos/Toast";
import { baixarArquivo, clonar, relativo, slug } from "../../util";

...
import { obterEstado, salvarFicha, salvarJulgamento, salvarRegra, usarCentral } from "../../banco/dados";
import {
  TIPOS_FICHA, entidadePorId, entidades, fichaDe, lerBloco, montarBloco,
  nomeDaEntidade, temFicha, type BlocoLido,
} from "./contexto-util";
import { copiarComAviso, toast } from "../../blocos/Toast";
import type { TipoFicha } from "../../tipos";
...
export function TelaTrocar() {
  ...
  return (
    <>
      ...
      {pendente && (
        <div className="overlay" onClick={(e) => { if (e.target === e.currentTarget) setPendente(null); }}>
          <div className="modal">
            <h3>Importar bloco</h3>
            <p className="hint">

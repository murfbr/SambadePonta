...
import { salvarFicha, usarCentral } from "../../banco/dados";
import { abrirFichaContexto, abrirJulgamento, definirFichaAberta, usarNavegacao } from "../../estado/navegacao";
import {
  TIPOS_FICHA, entidadePorId, entidades, fichaDe, julgamentosOrdenados,
  montarBloco, nomeDaEntidade, regrasDe, temFicha,
} from "./contexto-util";
import { LinhaRegra, type PedidoModalRegra } from "./Regras";
import { copiarComAviso, toast } from "../../blocos/Toast";
import { clonar } from "../../util";
import { ROTULO_RESULTADO, type Ficha, type TipoFicha } from "../../tipos";
